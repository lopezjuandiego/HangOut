...
def ahorcado():
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        ...
        print(vidas_diccionario_visual[vidas]) # muestra estado de la horca.
        print(f"Palabra: {' '.join(palabra_lista)}") # muestra las letras separadas por un espacio.
    ...
    # El juego llega a esta línea cuando se agotan las vidas 
    # o cuando gana.
    if vidas == 0:
